...
`@script`
In the previous section we saw how we use the matrix inverse to solve a system of linear equations with exactly one solution. In this section we look at situations without exact solutions find the best approximation using linear algebra
