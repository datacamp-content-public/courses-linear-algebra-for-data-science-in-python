...
`@script`
In the previous section we saw how we use the matrix inverse to solve a system of linear equations with exactly one solution. In this section we’ll use linear algebra to find the best approximation in situations without exact solutions.
