...
`@part2`
We can visualise this system as two intersecting straight lines{{2}}
...
`@script`
We have seen that a system of two equations with two unknowns, {{1}} can be represented as a matrix vector equation. {{2}} Graphically, this is two intersecting lines. 
