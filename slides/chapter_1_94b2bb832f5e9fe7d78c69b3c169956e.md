...
`@part2`
The pseudoinverse, denoted $A^{+}$, has the property: $\textbf{A}^{+}\textbf{A}\approx\textbf{I}${{2}}
...
`@part2`
The _pseudoinverse_, denoted $A^{+}$, has the property: $\textbf{A}^{+}\textbf{A}\approx\textbf{I}$
...
$$\vec{\beta} = \left[ {\begin{array}{c} \\; \enspace 3 \\\ -2 \end{array} } \right] \qquad \vec{\beta}^{*}= \left[ {\begin{array}{c} \\; \enspace 2.84 \\\ -2.04 \end{array} } \right]$${{3}}


`@part2`
![](https://assets.datacamp.com/production/repositories/4435/datasets/8551476101d6cc6cfd67fe6951f6834f760152a4/OLS.png){{4}}
